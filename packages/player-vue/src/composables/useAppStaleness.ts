 ...
 *
 * NATIVE SHELL ONLY, deliberately. On the web the service-worker banner
 * already owns this ground, a reload genuinely fixes it, and the sentence this
 * drives — go and install a newer app — would be false. So on the web this
 * composable never fetches and never fires.
 *
