...
<template>
  <div class="dashboard-view">
    <!-- Atmospheric layers (pure CSS, decorative only) -->
...
/* ============================================================
 * ATMOSPHERE LAYERS
 * Gold light pool top-left; whisper of red mist bottom-right;
 * paper-grain overlay. Purely decorative.
 * ============================================================ */
.atmosphere {
  position: fixed;
  inset: 0;
