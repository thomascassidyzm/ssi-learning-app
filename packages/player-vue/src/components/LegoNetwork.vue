...
const beltPalettes = {
  white: {
    ...
    glow: '#ffffff',
    link: { base: '#ffffff08', active: '#ffffff25' },
    accent: '#ffffff',
  ...
  yellow: {
    ...
    glow: '#fbbf24',
    link: { base: '#fbbf2410', active: '#fbbf2430' },
    accent: '#fbbf24',
  ...
  orange: {
    ...
    glow: '#f97316',
    link: { base: '#f9731612', active: '#f9731635' },
    accent: '#f97316',
  ...
  green: {
    ...
    glow: '#22c55e',
    link: { base: '#22c55e12', active: '#22c55e35' },
    accent: '#22c55e',
  ...
  blue: {
    ...
    glow: '#3b82f6',
    link: { base: '#3b82f612', active: '#3b82f635' },
    accent: '#3b82f6',
  ...
  purple: {
    ...
    glow: '#8b5cf6',
    link: { base: '#8b5cf612', active: '#8b5cf635' },
    accent: '#8b5cf6',
  ...
  brown: {
    ...
    glow: '#b45309',
    link: { base: '#92400e12', active: '#92400e35' },
    accent: '#b45309',
  ...
  black: {
    ...
    glow: '#d4a853',
    link: { base: '#d4a85315', active: '#d4a85340' },
    accent: '#d4a853',
