...
<template>
  <div class="group-row" :style="indentStyle">
    ...
    <span v-if="depth === 0" class="org-badge" :class="{ 'is-demo': group.is_demo }">
    ...
    <div class="row-actions">
      ...
      <button class="row-action" title="Add school here" @click="showAddSchool = !showAddSchool">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
  ...
  <div v-if="showAddSchool" class="tree-inline-form" :style="entityIndentStyle">
    <input
