...
const URL = process.env.PROBE_URL || 'https://ssi-learning-app-git-dev-zenjin.vercel.app/?podview=1&reset=1&stream'
const OUT = process.env.PROBE_OUT || '/home/tomcassidy/wt-pod-stage1/.probe-out'
