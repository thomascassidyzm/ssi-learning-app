...
--                                        security_invoker = ON
-- ============================================================================
-- ✅ APPLIED TO LIVE 2026-06-10 via keystone_canary.cjs (transaction-scoped:
--   apply -> replay signup/schools/guest consumers as service_role/
--   authenticated/anon -> 11/11 assertions green -> COMMIT only-if-green).
--   Independently re-verified persisted: 21/21 public views invoker=on.
--
