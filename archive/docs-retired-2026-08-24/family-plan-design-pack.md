...
| Client: checkout plan option, overlay title, price-id env config | `useCheckout.ts`, `CheckoutOverlay.vue`, `lib/paddle.ts` | — | **still-good, zero drift**; price ids env-only. **Paddle product CREATED (Tom, 2026-07-29): "SSi Family" `pro_01kypr214jhj3nwmn1bz8h1q4s`, monthly £25 `pri_01kypr3nmr37sqaq9sb50m3xn2`, yearly £250 `pri_01kyprde1jk6jfqpc3an10kmqg` — wire these into the env config in the billing stage** |
