...
|------|--------|-------------|
| [anyone-can-teach.md](./anyone-can-teach.md) | Working paper (2026-07-22) | Canonical home of the ACT thesis — a subject engine that self-sequences, self-paces, and self-assesses lets the teaching role decompose into presence/safety/alongsideness, independent of subject expertise. General across subjects: SSi is the first instance, Zenjin the second. Rendered page: `public/methodology/anyone-can-teach.html` |
