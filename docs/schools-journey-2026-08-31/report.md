...
[Screenshot — "Failed to update school", production, step 1 of the wizard](https://watson-1.tail4968cb.ts.net/journey-2026-08-31/09-wizfail-01-fail.png)
...
[Screenshot — the top of a new class page: five "Show me" links before anything you can act on](https://watson-1.tail4968cb.ts.net/journey-2026-08-31/17-class-01-class-detail.png)
...
5. **Step 3 of the wizard is a dead end for a trial school.** One course, unticked, Continue
   ...
   [Screenshot — step 3: one course, unticked, Continue greyed out](https://watson-1.tail4968cb.ts.net/journey-2026-08-31/13-wiz-01-s3.png)
...
[Screenshot — fixed: "Confirm your school's name" now appears for a head who skipped it](https://watson-1.tail4968cb.ts.net/journey-2026-08-31/36-devnew-01-dash.png)

And the end of the journey, working — a pupil who joined thirty seconds earlier, mid-cycle:

[Screenshot — the end of the journey: a pupil mid-cycle, "dw i'n moyn / I want"](https://watson-1.tail4968cb.ts.net/journey-2026-08-31/23-pupil-audio-01-playing.png)
