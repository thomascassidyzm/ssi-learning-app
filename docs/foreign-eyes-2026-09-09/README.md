...
Baseline: `4555418a` (origin/dev-derived private checkout). Read and report only. No application changes or tests. Candidate defects require independent verification before action.
...
No live database or deployment verification. Each area records its own limits and evidence.
